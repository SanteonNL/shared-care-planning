...
// Defines values for WalletOwnerType.
const (
	Organization WalletOwnerType = "organization"
...
// PresentationSubmission A presentation submission is a JSON object that describes the mapping between the required verifiable credentials listed in the presentation definition and the supplied verifiable presentation.
// Specified at https://identity.foundation/presentation-exchange/spec/v2.0.0/
...
// RequiredPresentationDefinitions Presentation Definitions, as described in Presentation Exchange specification, fulfilled to obtain the access token
...
// WalletOwnerType Wallet owner type that should fulfill the presentation definition.
...
type ClientInterface interface {
	...
	// GetRequestJWT request
	GetRequestJWT(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// PostRequestJWTWithBody request with any body
	PostRequestJWTWithBody(ctx context.Context, id string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	PostRequestJWTWithFormdataBody(ctx context.Context, id string, body PostRequestJWTFormdataRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) GetRequestJWT(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetRequestJWTRequest(c.Server, id)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PostRequestJWTWithBody(ctx context.Context, id string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostRequestJWTRequestWithBody(c.Server, id, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) PostRequestJWTWithFormdataBody(ctx context.Context, id string, body PostRequestJWTFormdataRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostRequestJWTRequestWithFormdataBody(c.Server, id, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewGetRequestJWTRequest generates requests for GetRequestJWT
func NewGetRequestJWTRequest(server string, id string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/oauth2/request.jwt/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewPostRequestJWTRequestWithFormdataBody calls the generic PostRequestJWT builder with application/x-www-form-urlencoded body
func NewPostRequestJWTRequestWithFormdataBody(server string, id string, body PostRequestJWTFormdataRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	bodyStr, err := runtime.MarshalForm(body, nil)
	if err != nil {
		return nil, err
	...
	bodyReader = strings.NewReader(bodyStr.Encode())
	return NewPostRequestJWTRequestWithBody(server, id, "application/x-www-form-urlencoded", bodyReader)
}

// NewPostRequestJWTRequestWithBody generates requests for PostRequestJWT with any type of body
func NewPostRequestJWTRequestWithBody(server string, id string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// GetRequestJWTWithResponse request
	GetRequestJWTWithResponse(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*GetRequestJWTResponse, error)

	// PostRequestJWTWithBodyWithResponse request with any body
	PostRequestJWTWithBodyWithResponse(ctx context.Context, id string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostRequestJWTResponse, error)

	PostRequestJWTWithFormdataBodyWithResponse(ctx context.Context, id string, body PostRequestJWTFormdataRequestBody, reqEditors ...RequestEditorFn) (*PostRequestJWTResponse, error)
...
type GetRequestJWTResponse struct {
	Body                          []byte
	HTTPResponse                  *http.Response
	ApplicationproblemJSONDefault *struct {
		// Detail A human-readable explanation specific to this occurrence of the problem.
...
// Status returns HTTPResponse.Status
func (r GetRequestJWTResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetRequestJWTResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type PostRequestJWTResponse struct {
	Body                          []byte
	HTTPResponse                  *http.Response
	ApplicationproblemJSONDefault *struct {
		// Detail A human-readable explanation specific to this occurrence of the problem.
...
// Status returns HTTPResponse.Status
func (r PostRequestJWTResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r PostRequestJWTResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// GetRequestJWTWithResponse request returning *GetRequestJWTResponse
func (c *ClientWithResponses) GetRequestJWTWithResponse(ctx context.Context, id string, reqEditors ...RequestEditorFn) (*GetRequestJWTResponse, error) {
	rsp, err := c.GetRequestJWT(ctx, id, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetRequestJWTResponse(rsp)
}

// PostRequestJWTWithBodyWithResponse request with arbitrary body returning *PostRequestJWTResponse
func (c *ClientWithResponses) PostRequestJWTWithBodyWithResponse(ctx context.Context, id string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostRequestJWTResponse, error) {
	rsp, err := c.PostRequestJWTWithBody(ctx, id, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostRequestJWTResponse(rsp)
}

func (c *ClientWithResponses) PostRequestJWTWithFormdataBodyWithResponse(ctx context.Context, id string, body PostRequestJWTFormdataRequestBody, reqEditors ...RequestEditorFn) (*PostRequestJWTResponse, error) {
	rsp, err := c.PostRequestJWTWithFormdataBody(ctx, id, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostRequestJWTResponse(rsp)
...
// ParseGetRequestJWTResponse parses an HTTP response from a GetRequestJWTWithResponse call
func ParseGetRequestJWTResponse(rsp *http.Response) (*GetRequestJWTResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetRequestJWTResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
// ParsePostRequestJWTResponse parses an HTTP response from a PostRequestJWTWithResponse call
func ParsePostRequestJWTResponse(rsp *http.Response) (*PostRequestJWTResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &PostRequestJWTResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
